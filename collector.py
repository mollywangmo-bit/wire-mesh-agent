...
BING_NEWS_QUERIES = [
    ...
    # 趋势-丝网交叉查询（跨品类关联）
    ("新能源汽车 电池 电极 金属丝网 集流体", "应用"),
    ("氢能 电解槽 PTL 多孔传输层 钛烧结网", "应用"),
    ("光伏 硅片 切割 金刚石线 金属丝", "应用"),
    ("半导体 蚀刻 精密金属掩膜版 丝网", "应用"),
    ("机器人 传感器 柔性 金属编织 触觉", "应用"),
    ("医疗器械 编织 支架 血管 介入 镍钛", "医疗卫生"),
    ("3D打印 金属点阵结构 替代 编织网", "丝材料"),
    ("陶瓷 金属 复合 过滤膜 丝网 替代", "丝材料"),
    ("环保 排放 标准 2026 升级 过滤 丝网", "环境保护"),
    ("基建 投资 丝网 护栏 声屏障 招标", "交通设施"),
